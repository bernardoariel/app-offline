...
import type { Vinculados, VinculadosForm } from '@/interfaces/index';
import {
  documentosDropdown,
  estadoCivilDropdown,
  instruccionDropdown,
...
const validationSchema = yup.object({
  ...
  email: yup
    ...
    .when('tipoDenuncianteSelect.name', {
      ...
      then: (schema) =>
        schema.required(
          'El correo es obligatorio para Vinculados tipo Detenido o Aprehendido'
        ),
