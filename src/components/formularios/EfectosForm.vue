...
import { useEfectos, useItemValue, useFieldsState, useActuacionData } from '@/composables/index';
import * as yup from 'yup';
import { useForm } from 'vee-validate';
import { MyDropdown, MyInput } from '@/components/elementos/index';
import type { Efectos, EfectosForm } from '@/interfaces/index';
import {
    categoriasDropdown,
            ...
            <div class="grid">
                ...
                <div class="col-6">
                    ...
                    <MyDropdown class="mt-2" :items="categoriasDropdown" v-model="categoriaSelect"
                        @change="handleDropdownChange('categoria', $event)" placeholder="Seleccione Categoría" filter
                        :color="false" :error="errors.categoriaSelect" v-bind="categoriaSelectAttrs" />
                ...
                <div class="col-6">
                    ...
                    <MyDropdown class="mt-2" :items="subcategoriasDropdown" v-model="subCategoriaSelect" @change="(newValue) => handleDropdownChange('subcategoria', newValue)
                        " placeholder="Seleccione Sub-Categoría" filter :color="false"
                        :error="errors.subCategoriaSelect" v-bind="subCategoriaSelectAttrs" />
                ...
                <div class="col-6">
                    ...
                    <MyDropdown class="mt-2" :items="getByIdSubcategorias()" v-model="tipoSelect"
                        @change="(newValue) => handleDropdownChange('tipo', newValue)" placeholder="Seleccione Tipo"
                        filter :color="false" :error="errors.tipoSelect" v-bind="tipoSelectAttrs" />
                ...
                <div class="col-6">
                    ...
                    <MyDropdown class="mt-2" :items="marcasCategoriasDropdown" v-model="marcaSelect"
                        @change="(newValue) => handleDropdownChange('marca', newValue)" placeholder="Seleccione Marca"
                        filter :color="false" :error="errors.marcaSelect" v-bind="marcaSelectAttrs" />
                ...
                <div class="col-6">
                    ...
                    <MyInput type="text" class="mt-2" v-model="nroChasis"
                        @input="handleInputChange('nroChasis', $event)" @blur="() => handleBlur('nroChasis')"
                        :color="false" />
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <MyInput type="text" class="mt-2" v-model="nroAbonado"
                        @input="handleInputChange('nroAbonado', $event)" @blur="() => handleBlur('nroAbonado')"
                        :color="false" />
                </div>
                <div class="col-6">
