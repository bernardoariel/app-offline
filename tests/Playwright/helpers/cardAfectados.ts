...
export const cardAfectadosUfiEspeciales =  async (page:any) =>{
  await page.getByTestId('AfectadosPlusButton').click();
  await page.getByLabel('Seleccione tipo de denunciante').click();
  await page.getByLabel('Fallecido', { exact: true }).click();
  await page.getByText('Seleccione tipo de doc.').click();
  await page.getByLabel('DNI').click();
  await page.getByPlaceholder('Ingrese N° de doc').click();
  console.log(dni);
...
export const cardAfectadosSiniestroVial =  async (page:any) =>{
  await page.getByTestId('AfectadosPlusButton').click();
  await page.getByLabel('Seleccione tipo de denunciante').click();
  await page.getByLabel('Protagonista', { exact: true }).click();
  await page.getByText('Seleccione tipo de doc.').click();
  await page.getByLabel('DNI').click();
  await page.getByPlaceholder('Ingrese N° de doc').click();
  console.log(dni);
