...
export const actuaciones: TipoActuaciones = {
  ...
  "ufi-delitos-especiales-paradero": {
    ...
    tituloAlternativo:
      "UNIDADES FISCALES DE INVESTIGACION D.E ESTABLECER PARADERO",
    tarjetas: {
      afectados: {
        titulo: "Afectados",
        valor: ["Denunciante"],
  ...
  "ufi-delitos-especiales-médicas": {
    ...
    tituloAlternativo:
      "UNIDADES FISCALES DE INVESTIGACION D.E EMERGENCIAS MEDICAS",
    tarjetas: {
      afectados: {
        titulo: "Afectados",
  ...
  "ufi-delitos-especiales-incendio-vivienda": {
    ...
    tituloAlternativo:
      "UNIDADES FISCALES DE INVESTIGACION D.E INCENDIO EN VIVIENDA",
    tarjetas: {
      afectados: {
        titulo: "Afectados",
        valor: ["Fallecido", "Damnificado"],
  ...
  "preliminares-incendio-vivienda": {
    ...
    datosLegales: {
      items: [
        "ACT. Preliminares N° / N° de extracto",
        "sitio",
        "modusOperandi",
        "causaCaratula",
        "listboxCausaCaratula",
