...
<template>
  <div class="grid">
    <div class="col-9">
      ...
      <MyInput type="text" class="mt-2" v-model="nroLegajo" color />
    </div>
    <div class="col-3">
      ...
      <MyDropdown
        ...
        :filter="false"
        color
        @change="(newValue) => handleDropdownChange('yearsActuacion', newValue)"
      />
    </div>
    <!-- Sitio -->
    <div class="col-12">
    ...
    <div class="col-12">
      ...
      <MyDropdown
        ...
        color
        @change="
          (newValue) => handleDropdownChange('selectedModusOperandi', newValue)
        "
        class="w-full mt-2"
      />
    </div>
    ...
    <div class="col-12">
      ...
      <MyDropdown
        ...
        color
        @change="
          (newValue) => handleDropdownChange('selectedCausaCaratula', newValue)
        "
        class="w-full mt-2"
      />
    </div>
    ...
    <div class="col-12">
      ...
      <MyDropdown
        ...
        @change="
          (newValue) =>
            handleDropdownChange('selectedJuzgadoInterviniente', newValue)
        "
        class="w-full mt-2"
      />
    </div>
