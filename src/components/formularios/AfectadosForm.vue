...
import { useAfectados, useItemValue, useFieldsState, useActuacionData, useNewActuacion, useCardValidations } from '@/composables/index'
import { MyDropdown, MyInput, MyTextArea, MyInputMask } from '@/components/elementos/index';
import type { AfectadosForm, Afectados } from '@/interfaces/index';
import {
    documentosDropdown,
    sexoDropdown,
...
const { defineField, values, errors } = useForm({ validationSchema });
                ...
                <div class="grid" v-if="!isOrdenPublico">
                    ...
                    <div class="col-12">
                        ...
                        <MyTextArea class="mt-2 w-full" placeholder="Ingrese Domicilio de residencia"
                            ...
                            :error="errors.domicilio" :color="false" />
                    </div>
                    <div class="col-12 flex flex-wrap align-items-end">
                        <div class="md:col-2 col-6">
                            ...
                            <MyInput type="number" class="mt-2" placeholder="Ingrese teléfono" v-model="telefono"
                                ...
                                :color="false" :error="errors.telefono" />
                        </div>
                        <div class="md:col-3 col-6">
                    ...
                    <div class="col-12">
                        ...
                        <MyTextArea class="mt-2 w-full" placeholder="Ingrese observaciones"
                            ...
                            @blur="() => handleBlur('observaciones')" v-model="observaciones as string"
                            :color="false" />
                    </div>
                </div>
